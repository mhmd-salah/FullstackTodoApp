  ...
  return (
    <div className="flex flex-col space-y-2 justify-center items-center">
      ...
      <div className="flex ">
        ...
        <button
          type="button"
          className="w-[130px] bg-teal-600 text-white rounded-l-md border-r border border-gray-100 flex items-center justify-center px-4 h-10 me-3 text-base font-medium rounded-lg hover:bg-teal-7     00 hover:text-white dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white disabled:bg-gray-400 disabled:hover:bg-gray-400 disabled:cursor-not-allowed"
